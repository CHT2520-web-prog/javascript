...
- Instead of simply changing the text we need to insert a hyperlink for each film in the array.
...
- We'll use the basic Laravel film app that we created previously.
